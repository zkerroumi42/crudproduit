...
require 'C:\xampp1\htdocs\db.class.php';
...
if (empty($imgsrc)) {
    ...
    if ($valid) {
    $DB = new DB();
    $produits = $DB->query('INSERT INTO produits (Nom,Description,Prix,Quantité_stock,Image,Catégorie) values(?,?,?,?,?,?)', array($nom,$description,$prix,$quantite,$imgsrc,$categorie));
    ...
    <div class="container-fluid ">
        <div class="row C1"> 
            <div class="col-md-2 colon1" ><!-- 1ere colonne -->
                ...
                <button class="my-button rounded-circle" onclick="window.location.href = 'index_admin.php'" style=" background-image: url('img/img.jpg');"></button> 
    ...
    <form class="form-horizontal" action="create.php" method="post" enctype="multipart/form-data">
        ...
        <div class="controls">
            ...
            <div class="form-actions">
                ...
                <a class="btn" href="index_admin.php">Back</a>
            </div>
    </form>
    </div>
